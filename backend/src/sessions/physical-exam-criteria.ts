...
> = {
  ...
  seizure_case_05: {
    ...
    items: [
      ...
      { examKey: 'kernig_sign', label: 'Kernig sign', expectedPosition: 'supine', status: 'abnormal', result: '무릎을 펴려고 할 때 허리/목/햄스트링 부위 통증, 저항, 무릎 신전 제한이 관찰됩니다.' },
      { examKey: 'brudzinski_sign', label: 'Brudzinski sign', expectedPosition: 'supine', status: 'abnormal', result: '목을 굽힐 때 양쪽 고관절과 무릎이 반사적으로 굽혀집니다.' },
      { examKey: 'neck_stiffness', label: '경부강직', expectedPosition: 'supine', status: 'abnormal', result: '목을 앞으로 굽히기 어렵고 심한 저항감, 통증, 목 굴곡 제한이 관찰됩니다.' },
