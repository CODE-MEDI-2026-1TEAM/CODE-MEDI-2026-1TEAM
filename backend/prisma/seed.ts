...
async function main() {
  const cpxCase = {
    ...
    patientPrompt: [
      '환자 정보:',
      '- 이름은 김준서이고 생년월일은 2005-02-14임.',
      '- 21세 남성 대학생이며 어제 한 차례 몸이 떨리는 일이 있었다고 들음.',
      '- 몸이 떨릴 당시 누워 있는 자세였고 어머니가 목격함.',
      '- 본인은 세수할 때까지는 기억하지만 이후 몸이 떨리던 당시 상황은 잘 기억하지 못함.',
      '- 수십 초 동안 양쪽 팔을 떨다가 축 처졌고 전체 상황은 10분 내외였다고 들음.',
      '- 몸이 떨리기 전 이상한 느낌은 없었음.',
      '- 눈이나 고개가 한쪽으로 돌아가지는 않았고 혀를 깨물거나 대소변 실금은 없었음.',
      '- 끝난 뒤 피곤했고 팔다리에 힘이 빠지는 느낌이 있었음.',
